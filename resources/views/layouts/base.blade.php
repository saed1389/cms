                        ...
                        <ul>
                            ...
                            @if(Route::has('login'))
                                @auth
                                    @if(Auth::user()->utype === 'ADM')
                                        <li class="menu-item menu-item-has-children parent">
                                            ...
                                            <ul class="submenu curency">
                                                ...
                                                <li class="menu-item">
                                                    <a href="{{route('admin.products')}}" title="Products">All
                                                        Products</a>
                                                </li>
                                                <li class="menu-item">
                                                ...
                                                <li class="menu-item">
                                                    <a href="{{route('admin.sale')}}"
                                                       title="Manage Home Categories">Sale Setting</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a href="{{route('admin.coupons')}}"
                                                       title="Manage Home Categories">All Coupons</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a href="{{ route('logout') }}"
                                    ...
                                    @endif
                                @else
                                    <li class="menu-item"><a href="{{route('login')}}" title="Login">Login</a></li>
                                    <li class="menu-item"><a href="{{route('register')}}" title="Login">Register</a></li>
                                @endif
                            @endif
                        </ul>
                    </div>
                ...
                <div class="primary-nav-section">
                    <div class="container">
                        <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
                            ...
                            <li class="menu-item">
                                <a href="/shop" class="link-term mercado-item-title">About Us</a>
                            </li>
                            <li class="menu-item">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/noUiSlider/15.5.1/nouislider.min.js"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script src="https://cdn.tiny.cloud/1/wkb9iql3yyt5gsnnkm5yriwd1qv4i9lt1kikpcmniurferk6/tinymce/5/tinymce.min.js"
